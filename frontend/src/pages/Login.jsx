...
const Login = () => {
  ...
  return (
    <form className='min-h-[80vh] flex items-center'>
      ...
      <div className='flex flex-col gap-3 m-auto p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-zink-600 text-sm shadow-lg'>
        ...
        <div className='w-full '>
          <p>Full Name</p>
          <input className='border border-zinc-300 rounded w-full p-2 mt-1' type="password" onChange={(e) => setPassword(e.target.name)} value={email} required />
        </div>
